...
//tests
console.log(containsDuplicate([1, 2, 3, 1])); //Output:
console.log(containDuplicate([1, 2, 3, 4])); //Output:
console.log(containsDuplicate1([1, 1, 1, 3, 3, 4, 3, 2, 4, 2])); //Output:
console.log(containsDuplicate1([])); //Output:
